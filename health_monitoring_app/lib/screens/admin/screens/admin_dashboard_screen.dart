            ...
            SizedBox(
              ...
              child: BarChart(
                BarChartData(
                  ...
                  barGroups: [
                    BarChartGroupData(x: 0, barRods: [BarChartRodData(toY: 20, color: const Color(0xFF1976D2), width: 16, borderRadius: BorderRadius.circular(4))]),
                    BarChartGroupData(x: 1, barRods: [BarChartRodData(toY: 40, color: const Color(0xFF1976D2), width: 16, borderRadius: BorderRadius.circular(4))]),
                    BarChartGroupData(x: 2, barRods: [BarChartRodData(toY: 35, color: const Color(0xFF1976D2), width: 16, borderRadius: BorderRadius.circular(4))]),
                    BarChartGroupData(x: 3, barRods: [BarChartRodData(toY: 60, color: const Color(0xFF1976D2), width: 16, borderRadius: BorderRadius.circular(4))]),
                    BarChartGroupData(x: 4, barRods: [BarChartRodData(toY: 80, color: const Color(0xFF1976D2), width: 16, borderRadius: BorderRadius.circular(4))]),
                    BarChartGroupData(x: 5, barRods: [BarChartRodData(toY: 90, color: const Color(0xFF1976D2), width: 16, borderRadius: BorderRadius.circular(4))]),
                  ],
                ),
              ),
            ),
