            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Liều dùng',
                    hintText: 'Ví dụ: 1 viên uống sau ăn',
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(12),
                    ),
                    prefixIcon: const Icon(
                ...
                DropdownButtonFormField<String>(
                  ...
                  items:
                      [
                          ...
                          .toList(),
                  onChanged: (v) =>
                      setDialogState(() => selectedTime = v ?? selectedTime),
                ),
              ],
            ),
          ),
              ...
              onTap: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    ...
                    content: Text(
                      'Đã xóa lịch uống thuốc Atorvastatin 20mg lúc 20:00',
                    ),
                  ),
                );
              },
