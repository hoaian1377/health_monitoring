                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (context) => AlertDialog(
                      ...
                      content: const Text(
                        'Được thiết kế riêng để có thể dễ dàng quản lý việc uống thuốc đúng giờ, đo chỉ số huyết áp/đường huyết và duy trì thói quen sống lành mạnh mỗi ngày.',
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  rate == 1.0 
                      ? 'Tuyệt vời! Đã hoàn thành mọi thứ.' 
                      : 'Cố lên! Còn một số nhiệm vụ chưa hoàn thành.',
                  style: const TextStyle(
                    fontSize: 11,
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 6),
          const Text(
            'Đã hoàn thành hết công việc của danh mục này.',
