...
class Caregiver(models.Model):
    ...
    phone = models.CharField(unique=True, max_length=10, db_collation='SQL_Latin1_General_CP1_CI_AS')
...
class Elderly(models.Model):
    ...
    medical_note = models.TextField(db_collation='SQL_Latin1_General_CP1_CI_AS', blank=True, null=True)  # This field type is a guess.
